<template>
  <v-container :class="$vuetify.breakpoint.smAndDown ? 'mt-12' : 'mt-4'">
    <h1 v-if="$vuetify.breakpoint.smAndDown" class="my-5 text-center">
      Mot du président
    </h1>
    <v-card
      class="text-center"
    ...
    <v-container>
      <h1 v-if="!$vuetify.breakpoint.smAndDown" class="text-center">
        Mot du président
      </h1>
